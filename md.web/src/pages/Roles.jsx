  ...
  return (
    <div>
      ...
      <Modal
        ...
        title={editing ? <><StatusIcon icon="✏️" sx={{ mr: 0.5, verticalAlign: 'middle' }} /> Rol Düzenle</> : <><StatusIcon icon="✨" sx={{ mr: 0.5, verticalAlign: 'middle' }} /> Yeni Rol</>}
      >
        <form onSubmit={saveForm}>
          {/* Rol Adı */}
          <div className="form-group">
            <label className="form-label">
              <StatusIcon icon="🔐" sx={{ mr: 0.5, verticalAlign: 'middle' }} /> Rol Adı <span style={{ color: 'var(--color-danger)' }}>*</span>
            </label>
            <input
              type="text"
          ...
          {/* İzinler */}
          <div className="form-group">
            <label className="form-label"><StatusIcon icon="🔑" sx={{ mr: 0.5, verticalAlign: 'middle' }} /> İzinler</label>
            <div 
              style={{
                padding: 16,
      ...
      <Modal
        ...
        title={<><StatusIcon icon="🗑️" sx={{ mr: 0.5, verticalAlign: 'middle' }} /> Rol Sil</>}
      >
